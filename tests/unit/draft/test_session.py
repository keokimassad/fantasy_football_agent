...
class TestPlayerResolution:
    """Resolving user-supplied player references."""

    def test_matches_yahoo_id(
        self,
    ...
    def test_normalizes_whitespace_and_name_case(
        self,
        make_player: Callable[..., Player],
    ) -> None:
        """
    ...
    def test_rejects_blank_reference(
        self,
        make_player: Callable[..., Player],
    ) -> None:
        """
    ...
    def test_rejects_unknown_yahoo_id(
        self,
        make_player: Callable[..., Player],
    ) -> None:
        """
    ...
    def test_suggests_close_name_matches(
        self,
        make_player: Callable[..., Player],
    ) -> None:
        """
    ...
    def test_omits_distant_name_suggestions(
        self,
        make_player: Callable[..., Player],
    ) -> None:
        """
...
class TestCurrentPickRecording:
    """Recording resolved or referenced players at the current pick."""

    def test_records_snake_metadata_and_advances(
        self,
    ...
    def test_accepts_yahoo_id_reference(
        self,
        league_config: LeagueConfig,
    ...
    def test_rejects_already_drafted_player(
        self,
        league_config: LeagueConfig,
    ...
    def test_records_resolved_player_without_name_lookup(
        self,
        league_config: LeagueConfig,
        make_draft_state: Callable[..., DraftState],
        make_player: Callable[..., Player],
...
class TestDraftStatePersistence:
    """Saving and undoing draft-state mutations."""
    ...
    def test_undo_restores_previous_pick_pointer(
        self,
        make_draft_pick: Callable[..., DraftPick],
        make_draft_state: Callable[..., DraftState],
    ) -> None:
    ...
    def test_undo_rejects_empty_state(
        self,
        draft_state: DraftState,
    ) -> None:
        """
