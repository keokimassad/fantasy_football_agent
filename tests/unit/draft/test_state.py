...
def test_load_league_config_reads_valid_json(tmp_path: Path) -> None:
    """
...
def test_load_draft_state_reconstructs_recorded_picks(tmp_path: Path) -> None:
    """
...
def test_validate_league_config_accepts_supported_snake_draft(
...
def test_validate_league_config_rejects_league_with_fewer_than_two_teams(
...
def test_validate_league_config_rejects_non_snake_draft(
    make_league_config: Callable[..., LeagueConfig],
) -> None:
    """
...
def test_validate_draft_state_accepts_valid_mock_session(
    league_config: LeagueConfig,
...
def test_validate_draft_state_rejects_unknown_session_type(
    league_config: LeagueConfig,
...
def test_validate_draft_state_rejects_slot_outside_league(
    draft_slot: int,
    league_config: LeagueConfig,
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_validate_draft_state_rejects_pick_before_start_of_draft(
    league_config: LeagueConfig,
    make_draft_state: Callable[..., DraftState],
) -> None:
    """
...
def test_team_for_overall_pick_uses_forward_order_in_first_round() -> None:
    """
...
def test_team_for_overall_pick_reverses_order_in_even_round() -> None:
    """
    GIVEN: a 10-team snake draft
...
def test_team_for_overall_pick_returns_to_forward_order_in_third_round() -> None:
    """
...
def test_team_for_overall_pick_rejects_pick_less_than_one() -> None:
    """
...
def test_get_team_roster_returns_only_team_picks_in_draft_order(
...
def test_get_team_position_counts_counts_each_drafted_position(
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
    """
...
def test_get_all_team_position_counts_includes_teams_without_picks(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_team_open_starter_slots_returns_full_starting_lineup_for_empty_team(
    league_config: LeagueConfig,
    draft_state: DraftState,
) -> None:
    """
...
def test_get_team_open_starter_slots_fills_dedicated_slot_before_flex(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_team_open_starter_slots_uses_eligible_overflow_player_for_flex(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_team_open_starter_slots_does_not_use_qb_overflow_for_flex(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_team_open_starter_slots_never_returns_negative_slots(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_team_open_starter_slots_omits_flex_when_league_has_no_flex_slot(
    league_config: LeagueConfig,
    draft_state: DraftState,
) -> None:
    """
...
def test_get_all_team_open_starter_slots_returns_context_for_every_team(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_next_pick_for_team_includes_current_pick_when_requested() -> None:
    """
...
def test_get_next_pick_for_team_skips_current_pick_when_requested() -> None:
    """
    GIVEN: draft slot 4 is currently on the clock at overall pick 17
...
def test_get_next_pick_for_team_handles_consecutive_turn_picks() -> None:
    """
...
def test_get_next_pick_for_team_rejects_team_outside_league(team_id: int) -> None:
    """
...
def test_get_active_lookahead_window_includes_current_opponent_pick_while_waiting(
    league_config: LeagueConfig,
    make_draft_state: Callable[..., DraftState],
) -> None:
    """
...
def test_get_active_lookahead_window_starts_after_current_pick_when_on_clock(
    league_config: LeagueConfig,
    make_draft_state: Callable[..., DraftState],
) -> None:
    """
...
def test_get_active_lookahead_window_is_empty_between_consecutive_turn_picks(
    league_config: LeagueConfig,
    make_draft_state: Callable[..., DraftState],
) -> None:
    """
...
def test_get_team_context_for_picks_groups_multiple_selections_by_team(
    league_config: LeagueConfig,
    draft_state: DraftState,
) -> None:
    """
...
def test_get_team_context_for_picks_uses_current_roster_needs_as_snapshot(
    league_config: LeagueConfig,
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
) -> None:
...
def test_get_team_context_for_picks_returns_empty_context_for_empty_window(
    league_config: LeagueConfig,
    draft_state: DraftState,
) -> None:
    """
