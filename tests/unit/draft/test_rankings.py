...
def test_load_rankings_parses_ranked_player_fields(tmp_path: Path) -> None:
    """
...
def test_load_rankings_normalizes_optional_blank_and_dash_values(
    tmp_path: Path,
) -> None:
    """
...
def test_load_rankings_accepts_decimal_text_for_manual_tier(
    tmp_path: Path,
) -> None:
    """
...
def test_get_available_players_excludes_drafted_yahoo_player_ids(
...
def test_get_available_players_ignores_recorded_pick_without_yahoo_id(
    make_draft_pick: Callable[..., DraftPick],
    make_draft_state: Callable[..., DraftState],
    make_player: Callable[..., Player],
) -> None:
...
def test_get_available_players_preserves_ranking_order(
...
def test_get_tier_players_filters_by_position_and_manual_tier(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_remaining_in_player_tier_counts_available_peers(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_remaining_in_player_tier_returns_none_for_untiered_player(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_next_position_tier_returns_closest_later_tier(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_next_position_tier_returns_none_when_no_later_tier_exists(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_next_position_tier_returns_none_for_untiered_player(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_is_last_in_tier_distinguishes_final_player_from_remaining_depth(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_get_position_tier_summary_groups_counts_and_omits_untiered_players(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_get_scarcity_flags_returns_none_for_untiered_player(
    make_player: Callable[..., Player],
) -> None:
    """
    GIVEN: an available player without a manual tier
...
def test_get_scarcity_flags_marks_last_player_and_large_tier_drop(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_get_scarcity_flags_marks_low_depth_without_large_drop(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_get_scarcity_flags_returns_empty_when_tier_depth_is_healthy(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_get_tier_coverage_counts_tiered_and_total_players_at_position(
    make_player: Callable[..., Player],
) -> None:
    """
...
def test_get_tier_coverage_returns_zero_counts_for_missing_position(
    make_player: Callable[..., Player],
) -> None:
    """
